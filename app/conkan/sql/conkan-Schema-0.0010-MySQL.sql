...
-- Created on Thu Jun 11 18:56:32 2015
-- 
...
CREATE TABLE pg_program (
  ...
  PRIMARY KEY (pgid),
  CONSTRAINT pg_program_fk_regpgid FOREIGN KEY (regpgid) REFERENCES pg_reg_program (regpgid) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE pg_progress (
  ...
  PRIMARY KEY (id),
  CONSTRAINT pg_progress_fk_regpgid FOREIGN KEY (regpgid) REFERENCES pg_reg_program (regpgid) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE pg_reg_cast (
  ...
  PRIMARY KEY (id),
  CONSTRAINT pg_reg_cast_fk_regpgid FOREIGN KEY (regpgid) REFERENCES pg_reg_program (regpgid) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB;
...
CREATE TABLE pg_reg_equip (
  ...
  PRIMARY KEY (id),
  CONSTRAINT pg_reg_equip_fk_regpgid FOREIGN KEY (regpgid) REFERENCES pg_reg_program (regpgid) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB;
